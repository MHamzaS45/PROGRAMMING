...
- Replace the placeholder filenames above with the real filenames present in Week 5.
- For each file, add a one-line description of the exercise and the primary programming fundamentals it practices.

Notes and learning goals
- Once the actual file list is added, include a short "How to run" section per script and any sample inputs or expected outputs.
